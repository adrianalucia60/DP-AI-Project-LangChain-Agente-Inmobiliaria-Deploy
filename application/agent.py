...
tools = [
    ...
    consultar_tipo_inmueble,        # Tipo de inmueble por ID (Google Sheets)
    consultar_alquiler_inmueble,    # Alquiler mensual por ID (Google Sheets)
    buscar_inmuebles,               # Búsqueda por barrio y características (Google Sheets)
]
